    ...
    ModelAbstract.prototype.save = function (options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.beforeValidate().then(function () {
                    ...
                    case 2:
                        _a.sent();
                        return [2 /*return*/, this.saveEmitter(options)
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.beforeUpdate()];
                    case 2:
                        _a.sent();
                        return [2 /*return*/, this.updateEmitter(options)
