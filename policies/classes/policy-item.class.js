    ...
    PolicyItem.setPolicyDescriptor = function (contextClass, propertyKey, next, failedResponseCode) {
        return function () {
            ...
            for (var _i = 0; _i < arguments.length; _i++) {
                applyArgs[_i] = arguments[_i];
            }
            return __awaiter(this, void 0, void 0, function () {
                var scope, functionArgs, policies, promises, _loop_1, _a, policies_1, policyId, state_1;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            scope = applyArgs[0];
                            functionArgs = applyArgs[1];
                            ...
                            return [4 /*yield*/, Promise.all(promises)
                                    .then(function () {
                                    return next.call.apply(next, [scope].concat(functionArgs));
                                })
                                    .catch(function (err) {
                                    if (err instanceof policy_error_exception_1.SugoiPolicyError)
                                        return err;
                                    else
                                        throw err;
                                })];
